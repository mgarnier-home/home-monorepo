...
func New(_ context.Context, cmd string, args ...string) (net.Conn, error) {
	...
	log.Printf("commandconn: starting %s with %v", cmd, args)
...
func (c *commandConn) Close() error {
	...
	if err := c.CloseRead(); err != nil {
		log.Printf("commandConn.Close: CloseRead: %v", err)
		return err
	}
	if err := c.CloseWrite(); err != nil {
		log.Printf("commandConn.Close: CloseWrite: %v", err)
		return err
	}
...
func (c *commandConn) SetDeadline(t time.Time) error {
	log.Printf("unimplemented call: SetDeadline(%v)", t)
	return nil
}

func (c *commandConn) SetReadDeadline(t time.Time) error {
	log.Printf("unimplemented call: SetReadDeadline(%v)", t)
	return nil
}

func (c *commandConn) SetWriteDeadline(t time.Time) error {
	log.Printf("unimplemented call: SetWriteDeadline(%v)", t)
	return nil
}
...
func (w *stderrWriter) Write(p []byte) (int, error) {
	log.Printf("%s%s", w.debugPrefix, string(p))
	w.stderrMu.Lock()
